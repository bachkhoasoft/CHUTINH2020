...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_id', help='Your Cloud Platform project ID.', default='assigntin2019')
    parser.add_argument(
        '--instance_id', help='ID of the Cloud Bigtable instance to connect to.', default='ads2019cxt')
    parser.add_argument(
        '--table',
